...
using PortableSoftManager.MG.Common;
using PortableSoftManager.MG.Data;
using PortableSoftManager.MG.Entity;
using PortableSoftManager.MG.Controls;
using CSharp_Util.Util;
using System.Threading;

namespace PortableSoftManager
{
    public partial class FrmFiles : Form
    {
        ...
        private void listViewFiles_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Right && selectListView.SelectedItems.Count > 0)
            {
                ...
                foreach (TabPage tabPage in this.tabFileGroup.TabPages)
                {
                    ...
                    toolStripItem.Image = PortableSoftManager.Properties.Resources.Group;
        ...
        private void initShortcutStyle()
        {
            ...
            foreach (BoxGroup group in groups)
            {
                ...
                listView.BackgroundImage = global::PortableSoftManager.Properties.Resources.bg2;
        ...
        private void initShortcutContentMenu()
        {
            ...
            toolStripItem.Image = PortableSoftManager.Properties.Resources.Love;
            toolStripItem.Click += new EventHandler(toolStripItem_Click);
            ...
            toolStripItem.Image = PortableSoftManager.Properties.Resources.Delete;
            toolStripItem.Click += new EventHandler(toolStripItem_Click);
            this.listViewContextMenuStrip.Items.Add(toolStripItem);
            ...
            toolStripItem.Image = PortableSoftManager.Properties.Resources.Rename;
            toolStripItem.Click += new EventHandler(toolStripItem_Click);
            this.listViewContextMenuStrip.Items.Add(toolStripItem);
            ...
            toolStripItem.Image = PortableSoftManager.Properties.Resources.Flush;
            toolStripItem.Click += new EventHandler(toolStripItem_Click);
            this.listViewContextMenuStrip.Items.Add(toolStripItem);
            ...
            toolStripItem.Image = PortableSoftManager.Properties.Resources.OpenFolder;
            toolStripItem.Click += new EventHandler(toolStripItem_Click);
            this.listViewContextMenuStrip.Items.Add(toolStripItem);
            ...
            toolStripItem.Image = PortableSoftManager.Properties.Resources.Move;
            toolStripItem.Click += new EventHandler(toolStripItem_Click);
            this.listViewContextMenuStrip.Items.Add(toolStripItem);
        }
        ...
        private void initLikeShortcutStyle()
        {
            ...
            listViewLove.BackgroundImage = global::PortableSoftManager.Properties.Resources.bg2;
        ...
        private void initLikeShortcutContentMenu()
        {
            ...
            toolStripItem.Image = PortableSoftManager.Properties.Resources.UnLove;
        ...
        private void initSetOptionContextMenu()
        {
            ...
            toolStripItem.Image = PortableSoftManager.Properties.Resources.Option;
            toolStripItem.Click += new EventHandler(toolStripItem_Click);
